  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        gold: "hsl(var(--gold))", silver: "hsl(var(--silver))", bronze: "hsl(var(--bronze))",
        "timer-focus": "hsl(var(--timer-focus))", "timer-short": "hsl(var(--timer-short-break))", "timer-long": "hsl(var(--timer-long-break))",
      ...
      keyframes: {
        ...
        "timer-tick": { "0%": { opacity: "1" }, "50%": { opacity: "0.7" }, "100%": { opacity: "1" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out",
        "fade-in": "fade-in 0.4s ease-out", "timer-tick": "timer-tick 1s ease-in-out infinite",
      },
    },
  },
